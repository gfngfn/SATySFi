SRCS=assoc.mli assoc.ml stacklist.mli stacklist.ml tyvarid.mli tyvarid.ml range.mli range.ml types.ml display.mli display.ml kindenv.mli kindenv.ml typeenv.mli typeenv.ml variantenv.mli variantenv.ml subst.mli subst.ml parser.mli parser.ml lexer.ml primitives.mli primitives.ml typechecker.mli typechecker.ml out.mli out.ml evaluator.mli evaluator.ml files.ml main.mli main.ml
