...
val main : breakability * length -> breakability * length -> context_main -> horz_box list -> vert_box list
...
val get_rightmost_script : horz_box list -> CharBasis.script option
