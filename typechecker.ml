...
let rec typecheck tyenv (rng, utastmain) =
...
and typecheck_pattern_match_cons tyenv (rng, utpmconsmain) tyobj theta tyres =
...
and typecheck_pattern tyenv (rng, utpatmain) =
